...
void ExternalPointerEffectTable::initializeTable()
{
	table = {
		...
		{"fwprintf", PointerEffect::NoEffect},
		...
		{"vfwprintf", PointerEffect::NoEffect},
		{"vprintf", PointerEffect::NoEffect},
		{"vwprintf", PointerEffect::NoEffect},
		...
		{"fgetws", PointerEffect::ReturnArg0},
		...
		{"bcopy", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memcpy.i32", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memcpy.p0i8.p0i8.i32", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memcpy.i64", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memcpy.p0i8.p0i8.i64", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memmove.i32", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memmove.p0i8.p0i8.i32", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memmove.i64", PointerEffect::MemcpyArg1ToArg0},
		{"llvm.memmove.p0i8.p0i8.i64", PointerEffect::MemcpyArg1ToArg0},
		{"memccpy", PointerEffect::MemcpyArg1ToArg0},
		{"memcpy", PointerEffect::MemcpyArg1ToArg0},
		{"memmove", PointerEffect::MemcpyArg1ToArg0},
		{"wmemcpy", PointerEffect::MemcpyArg1ToArg0},
