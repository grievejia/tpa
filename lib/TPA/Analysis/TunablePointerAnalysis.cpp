...
TunablePointerAnalysis::TunablePointerAnalysis(PointerManager& p, MemoryManager& m, const ExternalPointerTable& e): PointerAnalysis(p, m, e) {}
TunablePointerAnalysis::TunablePointerAnalysis(PointerManager& p, MemoryManager& m, const ExternalPointerTable& e, const Env& en): PointerAnalysis(p, m, e, en) {}
TunablePointerAnalysis::TunablePointerAnalysis(PointerManager& p, MemoryManager& m, const ExternalPointerTable& e, Env&& en): PointerAnalysis(p, m, e, std::move(en)) {}
